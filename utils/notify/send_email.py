...
class SendEmail:
    ...
    def send_mail(cls, user_list: list, sub, content: str) -> None:
        ...
        @return:
        """
        user = "Rainx" + "<" + config.email.send_user + ">"
    ...
    def error_mail(self, error_message: str) -> None:
        ...
        user_list = email.split(',')  # 多个邮箱发送，config文件中直接添加  '1106262459@qq.com'
    ...
    def send_main(self) -> None:
        ...
        """
        email = config.email.send_list
        user_list = email.split(',')  # 多个邮箱发送，yaml文件中直接添加  '1106262459@qq.com'
